...
The site uses **public/logo.svg** as the browser favicon (tab icon) and **public/logo.png** (1200×630) as the Open Graph image for social sharing (LinkedIn, Twitter, etc.).
