...
Here's where the rubber meets the road. Let me pull back the curtain on the actual code powering this thing.
...
- **`maxOutputTokens: 4096`** was the key to getting multi-verse poems instead of truncated single verses.
